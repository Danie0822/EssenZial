// Obtener el nombre del administrador del sessionStorage
const nombre_admins = sessionStorage.getItem("nombre_admin");

// Verificar si el nombre del administrador no está definido o está vacío
if (!nombre_admins) {
    // Redirigir a la página de inicio si no hay nombre del administrador
    ...
    var listItems = [
        ...
        '<li class="nav-item" id="out-item"><a class="nav-link" onclick="cerrarSesion()" ><img src="../../resources/img/salir.png" width="30" height="30" class="d-inline-block align-top" alt="">Salir</a></li>'
    ];
